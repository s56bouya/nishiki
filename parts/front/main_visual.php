...
if( get_bloginfo( 'description' ) !== '' ){
	...
	if( get_theme_mod( 'setting_top_main_visual_main_button_text', __( 'Get started!', 'nishiki' ) ) ){
		echo '<p class="main_button"><a href="' . esc_url( get_theme_mod( 'setting_top_main_visual_main_button_link', wp_login_url() ) ) . '">' . esc_html( get_theme_mod( 'setting_top_main_visual_main_button_text', __( 'Get started!', 'nishiki' ) ) ) . '</a></p>';
	}
	echo '</div>';
	if( has_header_video() ){
